...
CREATE TABLE IF NOT EXISTS item (
    item_id INT AUTO_INCREMENT PRIMARY KEY,          -- Unique ID for each item, auto-incremented
...
CREATE TABLE IF NOT EXISTS user_item (
    ...
    FOREIGN KEY (item_id) REFERENCES item(item_id)    -- Foreign key linking to the item table
);
...
INSERT IGNORE INTO item (item_id, Name, rarity, image_path)
VALUES (16, 'Rattata', 'common', '/collection_db/items_images/Rattata.png');

INSERT IGNORE INTO item (item_id, Name, rarity, image_path)
VALUES (17, 'Rayquaza', 'superultrarare', '/collection_db/items_images/Rayquaza.png');

INSERT IGNORE INTO item (item_id, Name, rarity, image_path)
VALUES (18, 'Snorlax', 'superrare', '/collection_db/items_images/Snorlax.png');

INSERT IGNORE INTO item (item_id, Name, rarity, image_path)
VALUES (19, 'Tangela', 'rare', '/collection_db/items_images/Tangela.png');

INSERT IGNORE INTO item (item_id, Name, rarity, image_path)
VALUES (20, 'Zubat', 'common', '/collection_db/items_images/Zubat.png');

INSERT IGNORE INTO item (item_id, Name, rarity, image_path)
VALUES (21, 'Zygarde', 'ultrarare', '/collection_db/items_images/Zygarde.png');
